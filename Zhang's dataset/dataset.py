...
class KnowledgeGraph:
    def __init__(self, data_dir):
        ...
        self.entity_dict = {}
        self.entities = []
        self.drugnegentities=[]
        self.diseasenegentities = []
        self.relation_dict = {}
        self.n_entity = 0
        self.n_relation = 0
        self.n_drug=0
        ...
        self.training_triples_kg_pool=set(self.training_triples_kg)
        self.neg_triples_pool=list(set(self.neg_triples))
